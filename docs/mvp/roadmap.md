...
> Verlauf erhalten. Laufende Weiterentwicklung wird in [../backlog.md](../backlog.md)
> getrackt.
...
|---|---|---|---|
| Produktvision | [vision.md](vision.md) | ✅ fertig | `37a9eac` |
| MVP Design-Spec (Architektur-Referenz) | [../superpowers/specs/2026-06-13-1435-zilpzalp-mvp-design.md](../superpowers/specs/2026-06-13-1435-zilpzalp-mvp-design.md) | ✅ fertig | `fdd181f` |
...
| 5a | **UI-Design & Beschreibung** | `docs/ui.md` (vollständige UI-Beschreibung) · Designsystem + statische HTML/CSS-Mockups je Seite (hell/dunkel) → `docs/ui/design/` | [ui.md](ui.md) | [Mockups](ui/design/) | ✅ fertig | `0ffb1ad` |
