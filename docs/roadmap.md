...
| 6 | **Endnutzer-Doku + Packaging** | `mkdocs/` (mkdocs-material), `Dockerfile.backend`, `Dockerfile.mkdocs`, `docker-compose.yml` | — (Design-Spec §2, §8) | [Plan](superpowers/plans/2026-06-14-1718-doku-packaging.md) | 📝 Plan in Arbeit | — |
