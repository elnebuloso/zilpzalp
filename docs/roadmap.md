...
| 5a | **UI-Design & Beschreibung** | `docs/ui.md` (vollständige UI-Beschreibung) · Designsystem + statische HTML/CSS-Mockups je Seite (hell/dunkel) → `docs/ui/design/` | [Web-UI-Spec](superpowers/specs/2026-06-14-0108-zilpzalp-web-ui.md) | [Mockups](ui/design/) | ✅ fertig | — |
