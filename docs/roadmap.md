...
| 5 | **Web-UI** | FastAPI-Routen, Jinja2+HTMX (Queue-Liste, Review-View mit **auswählbarer Datumsliste** §4.3, Config-Verwaltung, Zusammenfassung), Playwright-Tests, `docs/ui.md` | _tbd (UI-Spec empfohlen)_ | _tbd_ | 📋 geplant | — |
