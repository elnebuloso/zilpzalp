...
| 5a | **UI-Design & Beschreibung** | `docs/ui.md` (vollständige UI-Beschreibung) · Designsystem + statische HTML/CSS-Mockups je Seite (hell/dunkel) → `docs/ui/design/` | [Web-UI-Spec](superpowers/specs/2026-06-14-0108-zilpzalp-web-ui.md) | [Mockups](ui/design/) | ✅ fertig | `0ffb1ad` |
| 5b | **Web-UI-Umsetzung** | FastAPI-Routen, Jinja2+HTMX, Worker + Queue-/Config-Erweiterung, Playwright-Tests — **anhand 5a neu gebrainstormed** | [Architektur-Eingang](superpowers/specs/2026-06-14-0108-zilpzalp-web-ui.md) | _tbd (Brainstorm nach 5a)_ | 📋 geplant | — |
