...
| 4 | **Ingestion** | `watcher` (watchdog-Events + initialer Scan), `queue` (in-memory Register, Pfad-Dedup) | — (Design-Spec §4) | [Plan](superpowers/plans/2026-06-14-0038-ingestion.md) | 📝 Plan in Arbeit | — |
